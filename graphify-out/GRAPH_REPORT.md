# Graph Report - dashboardstudio  (2026-05-31)

## Corpus Check
- 240 files · ~217,128 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2465 nodes · 2788 edges · 283 communities (213 shown, 70 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 283 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `29a79c97`
...
## Communities (283 total, 70 thin omitted)
...
Cohesion: 0.06
Nodes (32): assignedDSplitIds, current, data, date, defs, dx, endpoint, f (+24 more)
...
Cohesion: 0.09
Nodes (20): Enum, ExecutionHistory, NodeExecutionLogs, ODSError, ODSResult, ODS Executor Service - Core execution engine for PostgreSQL ODS operations.  Thi, Detailed error information for a failed batch or record.          Attributes:, Result of an ODS execution operation.          Attributes:         success: True (+12 more)

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (18): ODSExecutor, Core executor for PostgreSQL ODS operations.          This class provides method, Validate ODSConfig (internal hook for validation)., Fetch all column names for the target table., Validate records for JSON serialization safety.                  Checks:, Fetch column names and their PostgreSQL data types., Align record keys with actual table columns:         - Filters out keys that do, Validate that the target schema and table exist.                  Args: (+10 more)
...
Cohesion: 0.11
Nodes (25): context, emitStatus(), executeScriptNode(), flow, FlowConnection, FlowData, FlowNode, getSubgraphNodes() (+17 more)
...
Cohesion: 0.11
Nodes (13): mock_get_current_user(), get_mock_db(), mock_get_current_user(), MockDS, ensure_user_exists(), get_current_user(), get_jwks(), Ensure user exists in database, create if not (+5 more)
...
Cohesion: 0.11
Nodes (13): authStore, router, routes, keycloak, cubeStore, llmStore, app, authStore (+5 more)
...
Cohesion: 0.21
Nodes (14): flow_logs_websocket(), Streaming de logs de ejecución vía WebSocket., Streaming de logs de ejecución vía WebSocket., Streaming de logs de ejecución vía WebSocket., execute_llm_node(), Executes an LLM completion call using an OpenAI-compatible endpoint.     Includ, _err(), _execute_http() (+6 more)
...
Cohesion: 0.18
Nodes (7): ChatRequest, AI Analyst FastAPI application.  Endpoints:   GET  /health  → {status: ok}   POS, startup_event(), execute_skill(), load_catalog(), Fetches the skills catalog from the remote URL and updates the global cache., Triggers an operational skill from the platform's catalog.          Use this t
...
Cohesion: 0.22
Nodes (8): delete_model(), get_model(), list_models(), Get specific model details., Delete a model and its associated file., Upload a scikit-learn .pkl model and extract its metadata., List all available ML models., upload_model()
...
Cohesion: 0.47
Nodes (5): inspect_model(), main(), predict_model(), Loads a model and extracts metadata: sklearn version and feature names., Reads JSON from stdin, predicts using the model, and prints results.
...
## Knowledge Gaps
- **1221 isolated node(s):** `Google ADK agent singleton.  The Runner and session_service are module-level sin`, `AI Analyst FastAPI application.  Endpoints:   GET  /health  → {status: ok}   POS`, `Fetches business data from CubeJS using the provided JSON query format.`, `Fetches the skills catalog from the remote URL and updates the global cache.`, `Triggers an operational skill from the platform's catalog.          Use this t` (+1216 more)
...
- **Why does `DenoService` connect `Community 53` to `Community 32`, `Community 36`, `Community 9`, `Community 11`, `Community 15`, `Community 16`, `Community 47`, `Community 24`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `process_sensitive_fields()` connect `Community 81` to `Community 69`, `Community 70`, `Community 8`, `Community 46`, `Community 53`, `Community 92`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `ODSExecutor` connect `Community 16` to `Community 15`, `Community 24`, `Community 26`, `Community 31`, `Community 44`, `Community 45`, `Community 53`, `Community 62`, `Community 75`, `Community 99`, `Community 100`, `Community 101`, `Community 102`, `Community 109`, `Community 110`, `Community 111`, `Community 112`, `Community 113`, `Community 125`, `Community 126`?**
...
- **Are the 26 inferred relationships involving `ODSConfig` (e.g. with `DenoService` and `ExecutionHistory`) actually correct?**
  _`ODSConfig` has 26 INFERRED edges - model-reasoned connections that need verification._