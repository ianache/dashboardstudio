...
## Corpus Check
- 179 files · ~161,135 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1481 nodes · 1551 edges · 176 communities (144 shown, 32 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 50 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bb643260`
...
Cohesion: 0.06
Nodes (29): global_exception_handler(), DenoService, Run Deno with the provided flow data., Run Deno with the provided flow data., Check if Deno is installed and accessible., Execute a simple script test in Deno., Run a full integration flow in Deno., Runs a flow in Deno and yields log messages.         Uses subprocess.run via ru (+21 more)
...
Cohesion: 0.12
Nodes (22): TokenData, create_data_source(), DataSourceCreate, DataSourceResponse, DataSourceUpdate, _decrypt_data_source_password(), delete_data_source(), _encrypt_data_source_password() (+14 more)
...
Cohesion: 0.1
Nodes (8): lifespan(), # NOTE: We manually add CORS headers here because unhandled exceptions can bypas, # NOTE: We manually add CORS headers here because unhandled exceptions can bypas, BaseSettings, get_settings(), Settings, init_db(), init_scheduler()
...
- **Why does `ensure_user_exists()` connect `Community 41` to `Community 34`, `Community 26`, `Community 40`, `Community 105`, `Community 11`, `Community 46`, `Community 16`, `Community 50`, `Community 19`, `Community 25`, `Community 58`, `Community 63`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `get_settings()` connect `Community 14` to `Community 48`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `_get_fernet()` connect `Community 48` to `Community 14`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
