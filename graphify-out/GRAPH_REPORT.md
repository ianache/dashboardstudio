...
## Corpus Check
- 231 files · ~215,801 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2433 nodes · 2760 edges · 278 communities (210 shown, 68 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 282 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d9243262`
...
- `lifespan()` --calls--> `init_scheduler()`  [INFERRED]
  backend/app/main.py → backend/app/services/scheduler.py
- `global_exception_handler()` --calls--> `type`  [INFERRED]
  backend/app/main.py → dashboard-app/src/views/DimensionalModelEditorView.vue

## Communities (278 total, 68 thin omitted)
...
Cohesion: 0.09
Nodes (27): activeRefreshes, requireAuth(), tokenRefresh(), claims, code_verifier, currentUrl, decodeJwt(), extractRoles() (+19 more)
...
Cohesion: 0.1
Nodes (31): create_data_source(), DataSourceCreate, DataSourceResponse, DataSourceUpdate, _decrypt_data_source_password(), _encode_config(), _encrypt_data_source_password(), _gen_id() (+23 more)
...
Cohesion: 0.13
Nodes (10): ensure_user_exists(), Ensure user exists in database, create if not, Ensure user exists in database, create if not, create_diagram_type(), list_diagram_types(), create_editor_tool(), _gen_id(), list_editor_tools() (+2 more)
...
Cohesion: 0.17
Nodes (8): mock_get_current_user(), get_mock_db(), mock_get_current_user(), MockDS, get_current_user(), get_jwks(), TokenData, verify_token()
...
Cohesion: 0.28
Nodes (12): flow_logs_websocket(), Streaming de logs de ejecución vía WebSocket., Streaming de logs de ejecución vía WebSocket., Streaming de logs de ejecución vía WebSocket., _err(), _execute_http(), _execute_mysql(), _execute_postgres() (+4 more)
...
Cohesion: 0.2
Nodes (7): ODSError, Detailed error information for a failed batch or record.          Attributes:, Test ODSError dataclass creation., Tests for the singleton instance., Test that ods_executor singleton exists., Test that ods_executor is a singleton., TestSingleton
...
Cohesion: 0.2
Nodes (9): Alcance Técnico y Arquitectura, Alcance Técnico y Arquitectura, Capacidades del Agente en esta Etapa, Capacidades del Agente en esta Etapa, Etapa 1: Agente Analista BI Base (Enfoque Datos y Acción), Etapa 2: Agente Analista BI Avanzado (Enfoque Semántico y de Negocio), PRD, Referencias Adicionales (+1 more)
...
## Knowledge Gaps
- **1206 isolated node(s):** `Patch tool catalog:   1. Update rest_api tool -> pure HTTP REST (remove graphql`, `Patch the rest_api editor tool to add graphql_query and graphql_variables fields`, `initial schema  Revision ID: 001 Revises:  Create Date: 2025-04-07`, `seed default data  Revision ID: 002 Revises: 001 Create Date: 2025-04-07`, `add llm_config table  Revision ID: 003 Revises: 002 Create Date: 2025-04-07` (+1201 more)
...
- **Why does `ODSExecutor` connect `Community 12` to `Community 5`, `Community 18`, `Community 22`, `Community 24`, `Community 26`, `Community 30`, `Community 44`, `Community 45`, `Community 61`, `Community 75`, `Community 88`, `Community 98`, `Community 99`, `Community 100`, `Community 107`, `Community 108`, `Community 109`, `Community 110`, `Community 111`, `Community 124`, `Community 125`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `DenoService` connect `Community 26` to `Community 35`, `Community 5`, `Community 10`, `Community 12`, `Community 47`, `Community 18`, `Community 22`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `ensure_user_exists()` connect `Community 38` to `Community 34`, `Community 69`, `Community 105`, `Community 106`, `Community 11`, `Community 43`, `Community 74`, `Community 80`, `Community 82`, `Community 52`, `Community 25`, `Community 60`?**
