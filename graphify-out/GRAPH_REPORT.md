...
## Communities (310 total, 76 thin omitted)
...
Cohesion: 0.08
Nodes (21): NodeExecutionLogs, ODSExecutor, Core executor for PostgreSQL ODS operations.          This class provides method, Validate ODSConfig (internal hook for validation)., Fetch all column names for the target table., Validate records for JSON serialization safety.                  Checks:, Fetch column names and their PostgreSQL data types., Align record keys with actual table columns:         - Filters out keys that do (+13 more)
...
Cohesion: 0.1
Nodes (17): Enum, ExecutionHistory, ODSError, ODSResult, ODS Executor Service - Core execution engine for PostgreSQL ODS operations.  Thi, Detailed error information for a failed batch or record.          Attributes:, Result of an ODS execution operation.          Attributes:         success: True, Supported write modes for ODS operations.          - APPEND: Insert records with (+9 more)
...
Cohesion: 0.18
Nodes (18): Base, ColorPalette, CubeConfig, Currency, Dashboard, DashboardAssignment, DataSource, DataType (+10 more)
...
Cohesion: 0.14
Nodes (11): executor(), mock_connection(), Unit tests for ODSExecutor.  Tests cover: - Data model creation (ODSConfig, ODSR, Create a fresh ODSExecutor instance., Create a sample ODSConfig for testing., Create a mock asyncpg connection., Tests for the singleton instance., Test that ods_executor singleton exists. (+3 more)
...
Cohesion: 0.33
Nodes (4): global_exception_handler(), test(), Validate configuration after initialization., type
...
- **Why does `DenoService` connect `Community 26` to `Community 34`, `Community 39`, `Community 12`, `Community 16`, `Community 49`, `Community 24`, `Community 25`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `type` connect `Community 127` to `Community 16`, `Community 0`, `Community 26`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `EmailPayload` connect `Community 49` to `Community 96`, `Community 1`, `Community 44`, `Community 12`, `Community 78`, `Community 79`, `Community 48`, `Community 45`, `Community 55`, `Community 26`, `Community 92`, `Community 93`?**
