# Graph Report - dashboardstudio  (2026-05-28)

## Corpus Check
- 217 files · ~210,486 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2286 nodes · 2601 edges · 262 communities (205 shown, 57 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 278 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e5b45922`
...
## Communities (262 total, 57 thin omitted)
...
Cohesion: 0.09
Nodes (23): requireAuth(), tokenRefresh(), claims, code_verifier, currentUrl, logoutUrl, oidcConfig, parameters (+15 more)
...
Cohesion: 0.11
Nodes (20): Enum, ExecutionHistory, NodeExecutionLogs, ODSError, ODSExecutor, ODSResult, ODS Executor Service - Core execution engine for PostgreSQL ODS operations.  Thi, Detailed error information for a failed batch or record.          Attributes: (+12 more)
...
Cohesion: 0.15
Nodes (16): mock_get_current_user(), TokenData, create_data_source(), DataSourceCreate, DataSourceResponse, DataSourceUpdate, _encode_config(), _encrypt_data_source_password() (+8 more)
...
Cohesion: 0.12
Nodes (11): Validate configuration after initialization., Validate ODSConfig (internal hook for validation)., Execute the configured ODS operation on the provided records.                  T, Validate records for JSON serialization safety.                  Checks:, Validate that the target schema and table exist.                  Args:, Validate that identity fields have a unique constraint.         Required for ups, Execute the configured ODS operation on the provided records.                  T, Execute the configured ODS operation on the provided records.                  T (+3 more)
...
Cohesion: 0.15
Nodes (11): Execute a single batch with retry logic.                  Args:             conf, Execute a single batch with retry logic.                  Args:             conf, Execute a single batch with retry logic.                  Args:             conf, Execute a single batch with retry logic.                  Args:             conf, Execute a single batch with retry logic.                  Args:             conf, Classify an exception into an ODSError.                  Maps asyncpg exceptions, Quote a SQL identifier (table/column name) safely.                  Validates th, Classify an exception into an ODSError.                  Maps asyncpg exceptions (+3 more)

### Community 70 - "Community 70"
Cohesion: 0.15
Nodes (11): Execute upsert (INSERT ON CONFLICT DO UPDATE) for a batch.                  Args, Build INSERT ON CONFLICT DO UPDATE query.                  Args:             con, Execute upsert (INSERT ON CONFLICT DO UPDATE) for a batch.                  Args, Build INSERT ON CONFLICT DO UPDATE query.                  Args:             con, Execute upsert (INSERT ON CONFLICT DO UPDATE) for a batch.                  Args, Execute upsert (INSERT ON CONFLICT DO UPDATE) for a batch.                  Args, Execute upsert (INSERT ON CONFLICT DO UPDATE) for a batch.                  Args, Build INSERT ON CONFLICT DO UPDATE query.                  Args:             con (+3 more)
...
Cohesion: 0.22
Nodes (6): ensure_user_exists(), Ensure user exists in database, create if not, create_diagram_type(), list_diagram_types(), list_knowledge_spaces(), List all knowledge spaces
...
Cohesion: 0.5
Nodes (3): get_current_user(), get_jwks(), verify_token()
...
## Knowledge Gaps
- **1133 isolated node(s):** `Patch tool catalog:   1. Update rest_api tool -> pure HTTP REST (remove graphql`, `Patch the rest_api editor tool to add graphql_query and graphql_variables fields`, `initial schema  Revision ID: 001 Revises:  Create Date: 2025-04-07`, `seed default data  Revision ID: 002 Revises: 001 Create Date: 2025-04-07`, `add llm_config table  Revision ID: 003 Revises: 002 Create Date: 2025-04-07` (+1128 more)
...
- **Why does `ensure_user_exists()` connect `Community 93` to `Community 32`, `Community 131`, `Community 36`, `Community 68`, `Community 104`, `Community 105`, `Community 106`, `Community 43`, `Community 76`, `Community 84`, `Community 86`, `Community 25`, `Community 59`, `Community 60`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `DenoService` connect `Community 26` to `Community 33`, `Community 37`, `Community 7`, `Community 12`, `Community 13`, `Community 46`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `process_sensitive_fields()` connect `Community 91` to `Community 67`, `Community 100`, `Community 36`, `Community 71`, `Community 75`, `Community 26`?**
