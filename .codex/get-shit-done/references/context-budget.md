...
The keys live in `.codex/settings.json` (project) or `C:/Users/ianache/Desktop/DATA/01-DOCUMENTOS/02-PROYECTOS/102-concesionarias/dashboardstudio/.codex/settings.json` (global) — **not** in `.planning/config.json`:
